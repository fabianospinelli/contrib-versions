Version applicable à compter du 19 décembre 2021

1.    Objet
-----------

La société Comuto SA (ci-après, « **BlaBlaCar** ») édite une plateforme de covoiturage accessible sur un site internet notamment à l’adresse [www.blablacar.be](http://www.blablacar.be/) ou sous forme d’application mobile et destinée à (i) mettre en relation des conducteurs se rendant à une destination donnée pour leur propre compte avec des passagers allant dans la même direction afin de leur permettre de partager le trajet et donc les frais qui y sont associés et (ii) réserver des billets pour des trajets d’autocar pris en charge par des Exploitants d’autocar (ci-après, la « **Plateforme** »).
...
Au moment de la « Connexion avec Facebook » ou de l’« Inscription avec un email » vous devez cliquer sur un bouton. En cliquant sur le bouton, vous reconnaissez avoir pris connaissance et accepter l’intégralité des présentes conditions générales d’utilisation.

Si vous utilisez votre compte pour vous connecter à la plateforme BlaBlaCar d’un autre pays, veuillez noter que (i) les conditions générales de cette plateforme, (ii) la politique de confidentialité de cette plateforme et (iii) les règles et réglementations statutaires de ce pays s’appliqueront. Cela signifie également qu’il est possible que les informations de votre Compte, y compris vos données personnelles, doivent être transférées à l’entité juridique exploitant cette autre plateforme. Veuillez noter que BlaBlaCar se réserve le droit de restreindre l’accès à la Plateforme aux utilisateurs dont il est raisonnablement certain qu’ils se situent en dehors du territoire de l’Union européenne.  
...
« **Annonce** » désigne une annonce concernant un Trajet posté sur la Plateforme par un Conducteur ;

« **Annonce de covoiturage** » désigne une annonce concernant un Trajet posté sur la Plateforme par un Conducteur ; 

« **Annonce de Bus** » désigne une annonce concernant un Trajet en Bus opéré par un Exploitant distribué sur la Plateforme ;

« **Exploitant d’autocar** » désigne une entreprise de transport professionnel de passagers qui a été autorisée par BlaBlaCar à faire de la publicité et à vendre ses Billets sur la Plateforme ;

« **Billet** » désigne le titre de transport nominatif en cours de validité, à la suite de la Commande pour un Trajet en Bus, constituant la preuve de l’existence d’un contrat de transport entre les Passagers l’Autocariste, lequel contrat est régi par les CGV, sans préjudice d’éventuelles conditions particulières additionnelles stipulées entre le Passager et l’Exploitant d’autocar visées sur le Billet. 
...
« **CGV** » désigne les Conditions Générales de Vente de l’Autocariste concerné selon le Trajet en Bus sélectionné par le Client, et les conditions particulières applicables, accessibles sur le Site, et que le Client reconnaît avoir lues avant de passer sa Commande;

« **Client** » désigne toute personne physique (Membre ou non) ayant acheté, soit pour son compte, soit pour le compte d’un tiers qui sera le Passager, un Billet de Bus par l’intermédiaire de la Plateforme pour effectuer un Trajet opéré par l’Autocariste ;
...
« **Passager** » désigne le Membre ayant accepté la proposition d’être transporté par le Conducteur ou, le cas échéant, la personne pour le compte de laquelle un Membre a réservé une Place ;

« **Participation aux Frais** » désigne, pour un Trajet de Covoiturage donné, la somme d’argent demandée par le Conducteur et acceptée par le Passager au titre de sa participation aux frais de déplacement ;

« **Place** » désigne la place réservée par un Passager à bord du véhicule d’un Conducteur ou du à bord d’un véhicule opéré par un Autocariste ;
...
« **Site** » désigne le site internet accessible à l’adresse [www.blablacar.be](http://www.blablacar.be/) ;

« **Sous-Trajet** » a le sens qui lui est donné à l’article 4.1 ci-dessous ;

« **Trajet** » désigne indistinctement un Trajet en Bus ou un Trajet de Covoiturage ;
...
* (vi)    le véhicule que vous comptez utiliser pour le Trajet en Covoiturage est une voiture de tourisme à 4 roues, disposant d’un maximum de 7 places assises, à l’exclusion des voitures dites « sans permis »
...
* (x)    vous utilisez un véhicule en parfait état de fonctionnement et conformes aux usages et dispositions légales applicables, notamment avec un certificat de contrôle technique à jour;
* (xi) vous êtes un consommateur et vous n’agissez pas à titre professionnel.
...
Vous êtes également informés de ce que dans le cas où vous vous présenteriez en tant que consommateur en utilisant la Plateforme alors que vous agissez en réalité à titre professionnel vous vous exposez aux sanctions prévues à l’article L.132-2 du Code de la consommation.
...
Toute utilisation des Services, que ce soit en qualité de Passager ou de Conducteur, est nominative. Le Conducteur comme le Passager doivent correspondre à l’identité communiquée à BlaBlaCar et aux autres Membres participant au Trajet en Covoiturage ou à l’Autocariste, le cas échéant.

Toutefois, BlaBlaCar permet à ses Membres de réserver une ou plusieurs Places pour le compte d’un tiers. Dans ce cas, vous vous engagez à indiquer avec exactitude au Conducteur, au moment de la Réservation, les prénom, âge et numéro de téléphone de la personne pour le compte de laquelle vous réservez une Place. Il est strictement interdit de réserver une Place pour un Trajet en Covoiturage pour un mineur voyageant seul âgé de moins de 13 ans. Dans le cas où vous réservez une Place pour un Trajet en Covoiturage pour un mineur voyageant seul âgé de plus de 13 ans, vous vous engagez à demander l’accord préalable du Conducteur et à lui fournir une autorisation des représentants légaux dûment remplie et signée.
...
Par ailleurs, il est interdit de publier une Annonce pour un Conducteur autre que vous-même.
...
Votre avis, ainsi que celui laissé par un autre Membre à votre égard, le cas échéant, ne sont visibles et publiés sur la Plateforme qu’après le plus court des délais suivants : (i) immédiatement après que vous ayez, tous les deux, laissés un avis ou (ii) passé un délai de 14 jours suivant le premier avis.

Vous avez la possibilité de répondre à un avis qu’un autre Membre a laissé sur votre profil. L’avis et votre réponse, le cas échéant, seront publiés sur votre profil.
...
BlaBlaCar peut prélèver, en contrepartie de l’utilisation de la Plateforme, au moment de la Réservation, des frais de service (ci-après, les « Frais de Service »). L’utilisateur sera informé en temps utile avant toute application des Frais de Service le cas échéant.

Les modalités de calcul des Frais de Service en vigueur accessibles [ici](https://www.fr.blablacar.be/blablalife/lp/nouvelle-grille-de-frais-de-reservation) sont fournies à titre informatif et n’ont aucune valeur contractuelle. BlaBlaCar se réserve le droit de modifier à tout moment les modalités  de calcul des Frais de Service. Ces modifications n’auront pas d’effet sur les Frais de Service acceptés par les utilisateurs avant la date de prise d’effet de ces modifications.

En ce qui concerne les trajets transfrontaliers, veuillez noter que les modalités de calcul du montant des Frais de Services et de la TVA applicable varient selon le lieu de départ et d’arrivée du Trajet.

Lorsque vous utilisez la Plateforme pour des Trajets transfrontaliers ou hors de Belgique les Frais de Services peuvent être facturés par une société affiliée de BlaBlaCar éditant la plateforme locale.

### 5.3.   Arrondis

Vous reconnaissez et acceptez que BlaBlaCar peut, à son entière discrétion, arrondir au chiffre supérieur ou inférieur les Frais de Service et la Participation aux Frais.
...
En utilisant la Plateforme en tant que Conducteur pour des Trajets en Covoiturage, vous confiez à BlaBlaCar un mandat d’encaissement du montant de la Participation aux Frais en votre nom et pour votre compte.
...
A la suite du Trajet en Covoiturage, les Passagers disposent d’un délai de 24 heures pour soumettre une réclamation à BlaBlaCar. A défaut de réclamation dans ce délai, BlaBlaCar considère le Trajet comme étant confirmé.
...
A l’issue des délais de prescription applicables, toute somme non réclamée à BlaBlaCar sera réputée appartenir à BlaBlaCar.

**5.4.3.   Paiement du Prix**
...
Le moyen de paiement peut différer selon la plateforme BlaBlaCar utilisée. Les moyens de paiement autorisés sont les suivants :

* Carte de crédit
* Paypal
* Bon d’achat

Aucune validation de Commande n’intervient avant le paiement intégral du prix des Prestations sélectionnées par le Client. Si le paiement présente une irrégularité, est incomplet ou s’il n’est pas effectué pour quelconque raison imputable au Client, la Commande sera immédiatement annulée.
...
La Confirmation de la Commande est définitive. Par conséquent, toute modification entraînera soit un échange, soit une annulation conformément aux Conditions Générales de Vente applicables. Il incombe au Client de s’assurer que les Services de Transport sont choisis en fonction des besoins et des attentes du Passager. L’exactitude des Données Personnelles complétées par le Client relève de la responsabilité de ce dernier, sauf en cas de manquement avéré de BlaBlaCar dans le cadre de la collecte, du stockage ou de la protection de ces Données Personnelles.

6.    Finalité non commerciale et non professionnelle des Services et de la Plateforme
--------------------------------------------------------------------------------------
...
Dans le cadre du Trajet de Covoiturage, vous reconnaissez que  les dispositions du droit de la consommation provenant du droit de l’Union Européenne ne s’appliquent pas à votre relation avec les autres Membres.
...
* Si le Passager annule plus de 24 heures avant l’heure prévue pour le départ telle que mentionnée dans l’Annonce de Covoiturage, le Passager n’est remboursé que du montant de la Participation aux Frais. Les Frais de Service demeurent acquis à BlaBlaCar et le Conducteur ne reçoit aucune somme de quelque nature que ce soit ;
...
* Lorsque l’annulation intervient avant le départ et du fait du Passager, la ou les Places annulé(e)s par le Passager sont de plein droit remises à la disposition d’autres Passagers pouvant les réserver en ligne et en conséquence soumises aux conditions des présentes CGU.
...
### 7.2.    Droit de rétraction

Conformément aux articles VI.45 et suivants du Code de droit économique, vous ne disposez d’aucun droit de rétraction à compter de la Confirmation de Réservation dans la mesure où le Contrat entre vous et BlaBlaCar consistant en la mise en relation avec un autre Membre a été pleinement exécuté.
...
* (vi)    ne pas tenter de contourner le système de réservation en ligne de la Plateforme, notamment en tentant de communiquer à un autre Membre ou à un Autocariste vos coordonnées afin de réaliser la réservation en dehors de la Plateforme et ne pas payer les Frais de Service ;
* (vii)    ne pas contacter un autre Membre, notamment par l’intermédiaire de la Plateforme, à une autre fin que celle de définir les modalités du covoiturage ;
...
* (ii) vous assurez que votre assurance couvre le covoiturage et que vos Passagers sont considérés comme tiers dans votre véhicule et donc couverts par votre assurance ;
...
* (v) effectuer le Trajet en Covoiturage tel que décrit dans l’Annonce (notamment en ce qui concerne l’emprunt ou non de l’autoroute) et respecter les horaires et lieux convenus avec les autres Membres (notamment lieu de rendez-vous et de dépose) ;
* (vi) ne pas prendre plus de Passagers que le nombre de Places indiquées dans l’Annonce de Covoiturage ;
* (vii) utiliser un véhicule en parfait état de fonctionnement et conformes aux usages et dispositions légales applicables, notamment avec un certificat de contrôle technique à jour  ;
...
Lorsque vous utilisez la Plateforme en tant que Passager d’un Trajet en Covoiturage, vous vous engagez à :
...
* (iv)    verser au Conducteur le montant de la Participation aux Frais convenu ;
* (v)    attendre le Conducteur sur le lieu de rencontre convenu au moins 15 minutes au-delà de l’heure convenue ;
* (vi)    communiquer à BlaBlaCar ou tout Conducteur qui vous en fait la demande, votre carte d’identité ou tout document de nature à attester de votre identité ;
* (vii)    ne transporter, lors d’un Trajet en Covoiturage, aucun objet, marchandise, substance, animal de nature à gêner la conduite et la concentration du Conducteur ou dont la nature, la possession ou le transport est contraire aux dispositions légales en vigueur ;
* (viii)    en cas de Trajet de Covoiturage transfrontalier, disposer et tenir à disposition du Conducteur et de toute autorité qui le solliciterait tout document de nature à justifier de votre identité et de votre faculté à franchir  la frontière ;
* (ix)    vous assurer d’être joignable par téléphone par le Conducteur, au numéro enregistré sur votre profil, notamment au point de rendez-vous.
...
BlaBlaCar n’a aucun contrôle sur le comportement de ses Membres, , des Autocaristes et de leurs préposés, et des utilisateurs de la Plateforme. Elle ne possède pas, n’exploite pas, ne fournit pas, ne gère pas les véhicules objets des Annonces, ni ne propose le moindre Trajets sur la Plateforme.
...
Dans le cadre des Trajets en Covoiturage, les Membres (Conducteurs ou Passagers) agissent sous leur seule et entière responsabilité.
...
* (i)    d’informations erronées communiquées par le Conducteur ou Autocariste, dans son Annonce, ou par tout autre moyen, quant au Trajet et à ses modalités ;
* (ii)    l’annulation ou la modification d’un Trajet par un Membre ou Autocariste ;
...
Les présentes CGU et les documents intégrés par référence expriment l’intégralité de l’accord entre vous et BlaBlaCar relative à votre utilisation des Services. Tout autre document, notamment toute mention sur la Plateforme (FAQ, etc.), n’a qu’une valeur informative.
...
Les présentes CGU sont rédigées en français et soumises à la loi belge.

Vous pouvez également présenter, le cas échéant, vos réclamations relatives à notre Plateforme ou à nos Services, sur la plateforme de résolution des litiges mise en ligne par la Commission Européenne accessible [ici](https://webgate.ec.europa.eu/odr/main/?event=main.home.show). La Commission Européenne se chargera de transmettre votre réclamation aux médiateurs nationaux compétents. Conformément aux règles applicables à la médiation, vous êtes tenus, avant toute demande de médiation, d’avoir fait préalablement part par écrit à BlaBlaCar de tout litige afin d’obtenir une solution amiable.

16.    Mentions légales
-----------------------

La Plateforme est éditée par la société Comuto SA, société anonyme au capital de 154.912,392 euros immatriculée au Registre du Commerce et des Sociétés de Paris, sous le numéro 491.904.546 (numéro de TVA intracommunautaire : FR76491904546) dont le siège social est situé au 84, avenue de la République – 75011 Paris (France), représentée par son CEO, Nicolas Brusson, Directeur de la publication du Site, inscrite à la Banque Carrefour des Entreprises sous le numéro 0644.636.363.

Le Site internet est hébergé sur des serveurs de Google Ireland Limited, dont le siège est établi à Gordon House, Barrow Street, Dublin 4 (Irlande). 

Comuto SA est immatriculée au registre des Exploitants de voyage et de séjour sous le numéro IM075180037.

La garantie financière est fournie par : Groupama Assurance-Crédit & Caution, 8-10 rue d’Astorg, 75008 Paris – France.

L’assurance responsabilité civile professionnelle a été souscrite auprès de : Hiscox Europe Underwriting Limited, 19, rue Louis Le Grand, 75002 Paris – France.

Comuto SA est immatriculée au registre des Intermédiaires en assurance, banque et finance (Orias) sous le numéro 15003890.

Pour toute question, vous pouvez contacter Comuto SA en utilisant [ce formulaire de contact](https://www.fr.blablacar.be/contact).